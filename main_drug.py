...
def main(args):
    ...
    if args.data== 'normal':
        ...
        model = BaselineDeepSetsFeatCat(train_data.num_entities + 1, args.embed_dim, args.hid_dim, args.out_dim).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_pkl', type=str, default='./data/small.pkl')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--lr', type=float, default=0.001)
    parser.add_argument('--batch_size', type=int, default=1024)
    parser.add_argument('--embed_dim', type=int, default=32) # refered to main_drug_eq.py # original 128
    parser.add_argument('--hid_dim', type=int, default=5)
    ...
    parser.add_argument('--train_fn', type=str, default='./data/small_train.csv')
    parser.add_argument('--test_fn', type=str, default='./data/small_test.csv')
